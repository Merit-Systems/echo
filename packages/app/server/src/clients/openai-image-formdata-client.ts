...
function makeImageEditRequest(): ResultAsync<void, Error> {
  return fromPromise(
    (async () => {
...
function makeImageEditRequestWithMultipleImages(): ResultAsync<void, Error> {
  return fromPromise(
    (async () => {
      // Initialize OpenAI client
      const client = new OpenAI({
...
// makeImageEditRequestWithMultipleImages().match(
//   () => {
//     console.log('\n');
