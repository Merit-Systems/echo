...
export class EchoOAuth2Api implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			description: 'OAuth2 scopes separated by spaces. Default includes LLM invocation and refresh token access.',
		},
		{
		...
		},
		{
			...
			default: '',
			required: false,
			description: 'Not required for Echo OAuth2. Echo uses PKCE (Proof Key for Code Exchange) for security instead of client secrets.',
		},
		{
