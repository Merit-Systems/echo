  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[400px]">
        <DialogHeader>
          <DialogTitle>Connect to Start Chatting</DialogTitle>
          <DialogDescription>
            Choose how you want to pay for AI chat — Echo credits or USDC via
            x402
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-3 py-4">
          ...
          >
            ...
            {isSigningIn ? 'Connecting...' : 'Pay with Echo Credits'}
          </Button>
